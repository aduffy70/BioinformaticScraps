#! /usr/bin/env python
# listgenesPsnu.py
#This script produces a non-redundant fasta file of the features in a genbank genome flat file (Optimized for Psilotum nudum and other genomes with the same annotation idiosyncrasies)
#Usage: listgenesPsnu.py <genbank flat file name> <taxon tag>
