...
for feature in gbRecord.features[1:]:
    ...
    # Is it a CDS, tRNA, or rRNA?
        ...
        if (feature.type == "tRNA"):
            ...
            if not((feature.qualifiers["product"][0] + "-" + antiCodon) in uniqueFeatures):
                uniqueFeatures = uniqueFeatures + [feature.qualifiers["product"][0] + "-" + antiCodon]
                print ">" + taxonTag + "_" + feature.qualifiers["product"][0] + "-" + antiCodon
            else:
                duplicate = True
